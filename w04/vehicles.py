def main():
    ...
    if vin in vehicles_dict:
        ...
        data_list = vehicles_dict[vin]
        manufacturer = data_list[MANUFACTURER_INDEX]
        model = data_list[MODEL_INDEX]
        color = data_list[COLOR_INDEX]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"Manufacturer: {manufacturer}, Model: {model}, Colour: {color}")
